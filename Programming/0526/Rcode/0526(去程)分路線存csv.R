...
#將路線分好存成csv
# write.csv(x11, file = "路線11.csv", row.names = F)
# write.csv(x22, file = "路線22.csv", row.names = F)
# write.csv(x33, file = "路線33.csv", row.names = F)
# write.csv(x44, file = "路線44.csv", row.names = F)
